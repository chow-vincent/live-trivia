...
import type { TrueFalseAnswer } from '@live-trivia/shared';

export default function TrueFalseGrading({ answer, points, onPointsChange }: GradingRowProps) {
  const tfAnswer = answer.answer as TrueFalseAnswer;
